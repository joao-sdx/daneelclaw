 ...
 * <ul>
 *   <li>{@code timer://} source endpoint with a {@code {{property}}} placeholder bridged from Spring config</li>
 *   <li>Processor to capture one shared {@code now} per tick as an exchange property</li>
 *   <li>Splitter EIP — one exchange per due task, processed sequentially</li>
 *   <li>Route-level {@code onException} for per-task error isolation</li>
 * </ul>
 */
@Component
